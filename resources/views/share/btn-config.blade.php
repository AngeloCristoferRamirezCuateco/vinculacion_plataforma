<div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
    <div class="offcanvas-header settings-panel-header bg-shape">
        <div class="z-1 py-1">
            <div class="d-flex justify-content-between align-items-center mb-1">
                <h5 class="text-white mb-0 me-2"><span class="fas fa-palette me-2 fs-9"></span>Ajustes</h5>
            ...
            <p class="mb-0 fs-10 text-white opacity-75"> Establece tu propio estilo personalizado</p>
        </div>
    ...
    <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
        <h5 class="fs-9">Esquema de colores</h5>
        <p class="fs-10">Elija el modo de color perfecto para su aplicación</p>
        ...
        <div class="d-flex justify-content-between">
            <div class="d-flex align-items-start"><img class="me-2" src="../assets/img/icons/left-arrow-from-left.svg" width="20" alt="" />
                <div class="flex-1">
                    ...
                    <p class="fs-10 mb-0">
                    Cambia la dirección de tu idioma</p>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-between">
            <div class="d-flex align-items-start"><img class="me-2" src="../assets/img/icons/arrows-h.svg" width="20" alt="" />
                <div class="flex-1">
                    <h5 class="fs-9">Diseño fluido</h5>
                    <p class="fs-10 mb-0">Alternar sistema de diseño de contenedores </p>
                </div>
            </div>
            <div class="form-check form-switch">
    ...
    <div class="card-body d-flex align-items-center py-md-2 px-2 py-1">
        ...
        </div><small class="text-uppercase text-primary fw-bold bg-primary-subtle py-2 pe-2 ps-1 rounded-end">personalizar</small>
    </div>
</a>
